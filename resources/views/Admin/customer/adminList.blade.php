...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 style="color:  #212529;" class="h3 mb-0 ">Admin List</h1>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $a->phone  }}</td>
                        <td>{{ $a->role  }}</td>
                        {{-- <td><a href="" class="btn btn-success">Edit Role</a>
                    ...
                    <tr>
                        ...
                        <td>{{ $a->phone  }}</td>
                        <td>{{ $a->role  }}</td>
                        <td><a href="{{ route('customer#changeRolePage',$a->id) }}" class="btn btn-success">Edit Role</a>
