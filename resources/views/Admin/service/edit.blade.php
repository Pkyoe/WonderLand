...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 style="color: blueviolet;" class="h3 mb-0 ">Edit Services & Package</h1>
        ...
        <div class="col-lg-6">
            <form action="{{ route('service#update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ old('servicePrice',$services->price) }}" name="servicePrice" type="number" class="form-control @error('servicePrice') is-invalid @enderror" id="exampleFormControlInput1" placeholder="Enter Service Price ...">
                    @error('servicePrice')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="serviceDescription" class="form-control @error('serviceDescription') is-invalid @enderror" id="exampleFormControlTextarea1" rows="3" placeholder="Enter Service Description ...">{{ old('serviceDescription',$services->description) }}</textarea>
                ...
                <button type="submit" class="btn btn-secondary border" style="background-color: blueviolet;">Update Service</button>
