    ...
    <div class="row d-flex justify-content-center mt-5">
        <div class="col-lg-6 card  p-3 shadow-sm border" style="background-color: lightyellow">
            ...
            <div class="col-5 offset-4 mt-1">
                ...
                <a href="{{ route('user#editProfilePage') }}"><button class="btn btn-secondary" style="background-color: limegreen">Edit</button></a>
                <a href="{{ route('user#homePage') }}"><button class="btn btn-secondary">Cancel</button></a>
            </div>
